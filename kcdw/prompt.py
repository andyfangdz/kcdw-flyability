...
Return only JSON matching the supplied schema. Produce exactly the seven report_dates and exactly these six windows per day, in order: 08-10, 10-12, 12-14, 14-16, 16-18, 18-20. Scores are integers in 5-point increments from 0 through 95. Never score above 95. Reduce apparent confidence as horizon increases. Convection/thunderstorms, active Convective SIGMETs, severe outlook language, low ceiling/visibility, excessive or gusty/cross winds, and disagreement among sources dominate small temperature/cloud differences. A 30% thunder probability does not mechanically mean 70% flyability. First-day observations may affect near-term windows; later days are forecast-only. KCDW has no routine TAF; describe KTEB/KEWR only as local proxies. Treat Open-Meteo as model guidance, not official aviation guidance. Choose distinct best and backup dates. Be concise and evidence-based. Do not invent sunset; the renderer handles the caveat from snapshot data."""
