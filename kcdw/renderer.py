...
def render(snapshot: dict, analysis: dict, now: datetime | None = None, previous: dict | None = None) -> tuple[str, dict]:
    ...
    section_nav = '<nav class="outlook-sections" aria-label="Outlook sections"><a href="#daily-outlook">Daily windows</a><a href="#weekly-ensembles">Ensemble ranges</a><a href="#synoptic-context">WPC / NHC / SPC</a></nav>'
